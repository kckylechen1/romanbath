...
import { CharacterFormData, getCharacterDetails } from '../services/sillyTavernService';
...
const CharacterEditor: React.FC<CharacterEditorProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/80 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-[#18181b] rounded-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden border border-white/10 shadow-2xl flex flex-col animate-in zoom-in-95 duration-200">
        {/* Header */}
        ...
        {isLoading ? (
          <div className="flex-1 flex items-center justify-center p-12">
            <div className="text-slate-500">Loading character data...</div>
          </div>
        ) : (
          <>
            {/* Tabs */}
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-6">
                    <div className="shrink-0">
                      <div
                        ...
                        className="w-32 h-32 rounded-2xl bg-slate-800 border-2 border-dashed border-slate-600 hover:border-purple-500/50 flex items-center justify-center cursor-pointer transition-colors overflow-hidden group"
                      >
                        {avatarPreview ? (
                    ...
                    <div className="flex-1 space-y-4">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full bg-slate-800/50 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-purple-500/50"
                        />
                      </div>
                      <div>
                        <label className="block text-sm font-medium text-slate-400 mb-2">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={3}
                      className="w-full bg-slate-800/50 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-purple-500/50 resize-none"
                    />
                  </div>
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <textarea
                      ...
                      rows={10}
                      className="w-full bg-slate-800/50 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-purple-500/50 resize-none font-mono text-sm"
                    />
                  </div>
                </div>
              )}
            ...
            <div className="p-6 border-t border-white/10 flex items-center justify-between shrink-0">
              ...
              <div className="flex gap-3">
                <button
                  onClick={onClose}
                  disabled={isSaving}
                  className="px-5 py-2.5 text-sm font-medium text-slate-400 hover:text-white hover:bg-white/5 rounded-xl transition-colors disabled:opacity-50"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="flex items-center gap-2 px-5 py-2.5 text-sm font-medium text-white bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 rounded-xl shadow-lg shadow-purple-900/30 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  <Save size={16} />
