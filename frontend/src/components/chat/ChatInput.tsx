...
export const ChatInput: React.FC<ChatInputProps> = ({
  ...
  return (
    <div className="p-4 md:p-8 z-20 bg-gradient-to-t from-[#090b0e] via-[#090b0e]/80 to-transparent">
      <div
        className={`max-w-4xl mx-auto relative group transition-transform ${leftSidebarOpen ? "" : "md:-translate-x-10"}`}
      >
        <div className="relative bg-[#0e1217]/60 backdrop-blur-2xl rounded-2xl p-2 flex items-end gap-2 ring-1 ring-white/5 focus-within:ring-bath-500/30 focus-within:bg-[#0e1217]/80 focus-within:shadow-[0_0_20px_rgba(102,252,241,0.08)] transition-all duration-300 shadow-2xl">
          <textarea
            value={inputText}
