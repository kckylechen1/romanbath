          ...
          {showMoreMenu && (
            <div className="absolute right-0 top-full mt-2 w-48 bg-[#0d0b09] border border-white/10 rounded-xl shadow-2xl z-50 animate-in fade-in slide-in-from-top-2 duration-200">
              <div className="p-1">
                ...
                <button
                  onClick={() => { setShowImageGen(true); setShowMoreMenu(false); }}
                  className="w-full flex items-center gap-3 px-3 py-2.5 text-sm text-stone-400 hover:text-white hover:bg-white/5 rounded-lg transition-colors"
                >
                  <Sparkles size={16} />
                  <span>Image</span>
                ...
                <button
                  onClick={() => { setShowBookmarks(!showBookmarks); setShowMoreMenu(false); }}
                  className="w-full flex items-center gap-3 px-3 py-2.5 text-sm text-stone-400 hover:text-white hover:bg-white/5 rounded-lg transition-colors"
                >
                  <Bookmark size={16} />
                  <span>Bookmarks</span>
                ...
                <button
                  onClick={() => { setShowChatHistory(!showChatHistory); setShowMoreMenu(false); }}
                  className="w-full flex items-center gap-3 px-3 py-2.5 text-sm text-stone-400 hover:text-white hover:bg-white/5 rounded-lg transition-colors"
                >
                  <History size={16} />
                ...
                <button
                  onClick={() => { setShowGroupManager(true); setShowMoreMenu(false); }}
                  className="w-full flex items-center gap-3 px-3 py-2.5 text-sm text-stone-400 hover:text-white hover:bg-white/5 rounded-lg transition-colors"
                >
                  <Users size={16} />
                ...
                {activeGroup && (
                  <button
                    onClick={() => { handleExitGroup(); setShowMoreMenu(false); }}
